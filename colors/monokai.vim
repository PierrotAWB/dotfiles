...
hi Boolean         guifg=#9ca0e0                              ctermfg=181
hi Character       guifg=#e3c74c gui=bold                     ctermfg=181 cterm=bold
hi Comment         guifg=#666c74 gui=italic                   ctermfg=108
hi Conditional     guifg=#eb5ba2 gui=bold                     ctermfg=223 cterm=bold
hi Constant        guifg=#eb5ba2 gui=bold                     ctermfg=181 cterm=bold
hi Cursor          guifg=#ffffff guibg=#c9f1f2 gui=bold       ctermfg=233 ctermbg=109 cterm=bold
hi Debug           guifg=#bca3a3 gui=bold                     ctermfg=181 cterm=bold
hi Define          guifg=#ffcfaf gui=bold                     ctermfg=223 cterm=bold
hi Delimiter       guifg=#acb4b0                              ctermfg=245
...
hi Function        guifg=#78c952                              ctermfg=228
hi Identifier      guifg=#e6beea                              ctermfg=223 cterm=none
hi IncSearch       guifg=#f8f893 guibg=#385f38                ctermfg=228 ctermbg=23
hi Keyword         guifg=#eb5ba2 gui=bold                     ctermfg=223 cterm=bold
...
hi Number          guifg=#b079b5                              ctermfg=116
hi Operator        guifg=#eb5ba2                              ctermfg=230
...
hi SpecialChar     guifg=#7e3282 gui=bold                     ctermfg=181 cterm=bold
hi SpecialComment  guifg=#82a282 gui=bold                     ctermfg=108 cterm=bold
hi Special         guifg=#ea53ed                              ctermfg=181
...
hi String          guifg=#e3c74c                              ctermfg=174
hi Structure       guifg=#ea53ed gui=bold                     ctermfg=229 cterm=bold
...
if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
    ...
    hi Normal        guifg=#dcdccc guibg=#021E26           ctermfg=188 ctermbg=237
